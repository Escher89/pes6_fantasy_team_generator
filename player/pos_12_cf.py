...
def cf():
    ...
    def role():
        ...
        if len(main_team_list) > 0:
            if "fw_wtm" not in types_fw and "cf_tm" in types_cf:
                types_cf.remove("cf_tm")
    ...
    if player_role == "cf_tm":
        mu = 185
        sigma = 5
        height_min = 178
        height_max = 202
        bmi_mu = 23.5
    elif player_role == "cf_p":
        mu = 178
        sigma = 5
        height_min = 160
        height_max = 188
        bmi_mu = 22.5
    elif player_role != "cf_tm" and player_role != "cf_p":
        mu = 182
        sigma = 5
        height_min = 174
        height_max = 202
