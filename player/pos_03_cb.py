...
def cb():
    ...
    def role():
        ...
        if len(main_team_list) > 0:
            types_cb = ["center back", "ball playing center back", "wide center back", "no non-sence center back"]
            ...
            ### only 2 wide center backs for formations with 3 defenders without a sweeper
            ...
            sub_cb_roles = ["center back", "ball playing center back", "wide center back", "no non-sence center back"]
