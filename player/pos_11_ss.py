...
def ss():
    ...
    def role():
        ...
        if len(main_team_list) > 0:
            ...
            if len(sub_roles_ss) > 0: 
                role = random.choice(sub_roles_ss)
                ### variety
    ...
    def second_pos():
        ...
        SMF = [0, 0, 0, 0]
        AMF = [choices(4,1), choices(4,1), choices(1,1), choices(1,1)]
        FW =  [0, 0, choices(1,1), 0]
        SS =  [1, 1, 1, 1]
        CF =  [choices(1,1), choices(1,1), choices(1,1), 1]
    ...
    print("Position: SS   #",CLUB_NUMBER, second_positions)
