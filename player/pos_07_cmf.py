...
def cmf():
    ...
    def second_pos():
        ...
        CB =  [0, 0, 0, 0, choices(6,1), 0, 0, 0]
        SB =  [0, 0, 0, 0, 0, 0, 0, choices(8,1)]
        DMF = [choices(3,1), choices(2,1), choices(1,1), 0, choices(1,1), choices(2,1), 0, choices(2,1)]
        WB =  [0, 0, 0, 0, 0, 0, 0, choices(4,1)]
        CMF = [1, 1, 1, 1, 1, 1, 1, 1]
        SMF = [0, 0, 0, 0, 0, 0, choices(1,1), choices(2,1)]
        AMF = [choices(3,1), 0, choices(2,1), choices(1,1), 0, choices(2,1), choices(1,1), 0]
        FW =  [0, 0, 0, 0, 0, 0, 0, 0]
        SS =  [0, 0, 0, 0, 0, 0, choices(8,1), 0]
        CF =  [0, 0, 0, 0, 0, 0, 0, 0]
    ...
    print("Position: CMF   #",CLUB_NUMBER,second_positions)
