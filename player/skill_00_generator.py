...
def skills(points,ATTACK,DEFENCE,BALANCE,STAMINA,TOP_SPEED,ACCELERATION,RESPONSE,
           ...
           FREE_KICK_ACCURACY,CURLING,HEADER,JUMP,TECHNIQUE,AGGRESSION,MENTALITY,
           KEEPER_SKILLS,TEAM_WORK):

    liste2 = [ATTACK,DEFENCE,BALANCE,STAMINA,TOP_SPEED,ACCELERATION,RESPONSE,AGILITY,
              DRIBBLE_ACCURACY,DRIBBLE_SPEED,SHORT_PASS_ACCURACY,SHORT_PASS_SPEED,
              LONG_PASS_ACCURACY,LONG_PASS_SPEED,SHOT_ACCURACY,SHOT_POWER,SHOT_TECHNIQUE,
              FREE_KICK_ACCURACY,CURLING,HEADER,JUMP,TECHNIQUE,AGGRESSION,MENTALITY,KEEPER_SKILLS,TEAM_WORK]
    
    liste = ["ATT","DEF","BAL","STA","TOP","ACC","RES","AGI","DAC","DSP","SPA","SPS","LPA",
             "LPS","SAC","SPO","STE","FKA","CUR","HEA","JUM","TEC","AGG","MENT","KEE","TEA"]
