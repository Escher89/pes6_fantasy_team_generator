...
def gk():
    ...
    def attack_01():
        ...
        x = int(fac * ((skill_role_gk[player_role] + skill_pos[position]) / 2))
        return x
    ...
    def balance_03():
        ...
        x = int(((fac + str_fac) / 2) * ((skill_role_gk[player_role] + skill_pos[position]) / 2))
        return x
    ...
    def stamina_04():
        ...
        x = int(factor() * 5 + ((skill_role_gk[player_role] + skill_pos[position]) / 2)) 
        return x
    STAMINA = stamina_04()
